...
(function ($) {
    $.parser = {
        ...
        parseOptions: function (_b, _c) {
            ...
            $.map(["width", "height", "left", "top", "minWidth", "maxWidth", "minHeight", "maxHeight", "textAlign"], function (p) {
                //alert(p);
    ...
    var _78f = $.extend({}, $.fn.datagrid.defaults.view, {
        ...
        renderGroup: function (_795, _796, _797, _798) {
            ...
            if ((_798 && (opts.rownumbers || opts.frozenColumns.length)) || (!_798 && !(opts.rownumbers || opts.frozenColumns.length))) {
                _79b.push("<td style=\"border:0;text-align:center;width:22px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
            }
        ...
        onBeforeRender: function (_7a6, rows) {
            ...
            function _7a8() {
                if (!$("#datagrid-group-style").length) {
                    $("head").append("<style id=\"datagrid-group-style\">" + ".datagrid-group{height:22px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;}" + "</style>");
                }
            }
        ;
        }
