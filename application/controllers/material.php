...
class material extends CI_Controller {
    ...
    function index() {
        ...
        $data['action'] = explode('|', $this->model_user->getAction($this->session->userdata('id'), "material"));
    ...
    function get() {
        ...
        echo $this->model_material->get($page, $rows, $query);
    }
    ...
    function get_remote_data() {
        ...
        echo $this->model_material->get_remote_data($query);
    }
    ...
    function save() {
        ...
        if ($this->model_material->insert($data)) {
    ...
    function update($code) {
        ...
        if ($this->model_material->update($data, array("code" => $code))) {
            echo json_encode(array('success' => true));
        } else {
            echo json_encode(array('msg' => $this->db->_error_message()));
        }
    ...
    function delete() {
        $code = $this->input->post('code');
        if ($this->model_material->delete(array("code" => $code))) {
            echo json_encode(array('success' => true));
        } else {
            echo json_encode(array('msg' => $this->db->_error_message()));
        }
