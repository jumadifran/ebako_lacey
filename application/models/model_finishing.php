...
class model_finishing extends CI_Model {
    ...
    function selectAllResult() {
        return $this->db->get('finishing')->result();
    }

    function insert($data) {
        return $this->db->insert('finishing', $data);
    }

    function update($data, $where) {
        return $this->db->update('finishing', $data, $where);
    }

    function delete($where) {
        return $this->db->delete('finishing', $where);
    }
