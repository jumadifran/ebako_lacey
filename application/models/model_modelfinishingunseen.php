...
/**
 * Description of model_modelfinishingunseen
 *
 * @author hp
 */
class model_modelfinishingunseen extends CI_Model {
    ...
    function insert($data) {
        return $this->db->insert('modelfinishingunseen', $data);
    }

    function update($data, $where) {
        return $this->db->update('modelfinishingunseen', $data, $where);
    }

    function delete($where) {
        return $this->db->delete('modelfinishingunseen', $where);
    }
