<form id="finishingtop-input" method="post" novalidate>
        ...
        <tr>
            ...
            <td>
                <input class="easyui-combobox" name="finishingtypeid" data-options="
                       url: '<?php echo site_url('finishingtype/get_by_position/2') ?>',
                       method: 'post',
                       valueField: 'id',
                       textField: 'name',
                       panelHeight: '200',
                       formatter: formatFinishingTypeTop"
                       style="width: 200px" 
                       required="true">
                <script type="text/javascript">
                    function formatFinishingTypeTop(row){
