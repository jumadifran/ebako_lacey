<form id="upholstry-input" method="post" novalidate>
    <table width="100%" border="0">            
        ...
        <tr>
            ...
            <td>
                <input type="text" id="upholstryitemid" name="itemid" required style="width: 270px"/>
                <script type="text/javascript">
                    $(function() {
                        $('#upholstryitemid').combobox({
                            ...
                            panelHeight: '200',
                            mode: 'remote',
                            formatter: upholstryItemFormat,
                            onSelect:function(row){
                                $('#upholstrymaterialdescription').val(row.description);
                                $('#upholstryunitcode').combobox('clear');
                                $('#upholstryunitcode').combobox('reload', base_url + 'itemunitprice/get_remote_unit/' + row.id);
                                $('#upholstryunitcode').combobox('setValue',row.unitcode);
                            }
                        });
                    });
                    function upholstryItemFormat(row){
        ...
        <tr>
            ...
            <td>
                <input name="materialdescription" id="upholstrymaterialdescription" class="easyui-validatebox" readonly="true" style="width: 270px;">
            </td>
        </tr>
        <tr>
            <td align="right"><label class="field_label">Unit Code :</label></td>
            <td>
                <input id="upholstryunitcode" name="unitcode" panelHeight="auto" editable="false" class="easyui-combobox" data-options="valueField:'id',textField:'text'" required="true" style="width: 100px;">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="qty" style="text-align: center" class="easyui-numberbox" precision="2" size="5" value=""/></td>
        </tr>
        <tr>
