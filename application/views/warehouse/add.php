<div id="warehouse-form" class="easyui-dialog" 
     data-options="iconCls:'icon-save',resizable:true,modal:true"
     style="width:300px; padding: 5px 5px" closed="true" buttons="#warehouse-button">
    <form id="warehouse-input" method="post" novalidate>
...
<div id="warehouse-button">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="warehouse_save()">Save</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="$('#warehouse-form').dialog('close')">Cancel</a>
</div>