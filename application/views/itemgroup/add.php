<div id="itemgroup-form" class="easyui-dialog" 
     data-options="iconCls:'icon-save',resizable:true,modal:true"
     style="width:300px; padding: 5px 5px" closed="true" buttons="#itemgroup-button">
    <form id="itemgroup-input" method="post" novalidate>
...
<div id="itemgroup-button">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="itemgroup_save()">Save</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="$('#itemgroup-form').dialog('close')">Cancel</a>
</div>