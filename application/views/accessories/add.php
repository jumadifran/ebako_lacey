<div id="accessories-form" class="easyui-dialog" 
     ...
     style="width:300px; padding: 5px 5px" closed="true" buttons="#accessories-button">
    <form id="accessories-input" method="post" novalidate class="table_form">
...
<div id="accessories-button">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="accessories_save()">Save</a>
